...
namespace Biographic.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(32, ErrorMessage = "Името трябва да бъде между 1 и 32 букви", MinimumLength = 1)]
            [Display(Name = "Име")]
            public string FirstName { get; set; }

            [Required(ErrorMessage = "Въведи фамилия")]
            [StringLength(32, ErrorMessage = "Фамилията трябва да бъде между 1 и 32 букви", MinimumLength = 1)]
            [Display(Name = "Фамилия")]
            public string LastName { get; set; }

            [Required(ErrorMessage = "Въведи псевдоним")]
            [Display(Name = "Псевдоним")]
            [StringLength(32, ErrorMessage = "Псевдонимът трябва да бъде между 1 и 32 букви", MinimumLength = 1)]
